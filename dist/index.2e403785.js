...
})({"d8AvX":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "1c79c7e42e403785";
"use strict";
...
},{}],"1LSgd":[function(require,module,exports) {
var _nationalInsuranceJs = require("./nationalInsurance.js");
var _incomeTaxJs = require("./incomeTax.js");
// DOM elements
const btnCalculate = document.querySelector(".btn-calculate");
const inputAnnualIncome = document.querySelector(".input-gross-income");
const pensionMonthlyContribution = document.querySelector(".input-pension-contribution");
const monthlyGrossIncomeLabel = document.querySelector(".monthly-gross-income");
const monthlyNationalInsuranceLabel = document.querySelector(".monthly-national-insurance");
...
const nationalInsurance = new (0, _nationalInsuranceJs.NationalInsurance)();
const incomeTax = new (0, _incomeTaxJs.IncomeTax)();
// Validations
...
btnCalculate.addEventListener("click", function(event) {
    ...
    monthlyGrossIncomeLabel.textContent = `Your monthly gross income is: \xa3${grossMonthlyIncome}`;
    const taxableIncome = +(annualIncome - monthlyPension * 12).toFixed(2);
    const monthlyNationalInsurance = nationalInsurance.calculateMonthlyNationalInsurance(annualIncome).toFixed(2);
    monthlyNationalInsuranceLabel.textContent = `Your monthly national insurance is: \xa3${monthlyNationalInsurance}`;
    const monthlyIncomeTax = (incomeTax.calculateAnnualIncomeTax(taxableIncome) / 12).toFixed(2);
    monthlyIncomeTaxLabel.textContent = `Your monthly income tax is: \xa3${monthlyIncomeTax}`;
    monthlyNetLabel.textContent = `Your monthly net income is: \xa3${(grossMonthlyIncome - monthlyNationalInsurance - monthlyIncomeTax).toFixed(2)}`;
});

},{"./nationalInsurance.js":"16paf","./incomeTax.js":"c0hW1"}],"16paf":[function(require,module,exports) {
